        ...
        <div class="layui-side layui-bg-black kit-side">
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="kitNavbar" kit-navbar>
                  ...
                  <li class="layui-nav-item layui-nav-itemed">
                        <a href="#"><i class="fa fa-plug" aria-hidden="true"></i><span>基本资料</span></a>
                        <dl class="layui-nav-child">
                            <dd><a href="#" kit-target data-options="{url:'Showgoogol_user.jsp',icon:'&#xe658;',title:'Navbar',id:'6'}"><i class="layui-icon">&#xe658;</i><span>职员信息</span></a></dd>
                             <dd><a href="#" kit-target data-options="{url:'Deptinfo_show.jsp',icon:'&#xe658;',title:'Navbar',id:'6'}"><i class="layui-icon">&#xe658;</i><span>进货信息</span></a></dd>
