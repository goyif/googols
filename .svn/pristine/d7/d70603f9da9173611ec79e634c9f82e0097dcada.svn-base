...
<link href="shouji/css/lines.css" rel='stylesheet' type='text/css' />
<link href="shouji/css/clndr.css" rel='stylesheet' type='text/css' />
<link href="shouji/css/font-awesome.css" rel="stylesheet"> 
<link href="shouji/css/custom.css" rel="stylesheet">
<link href="shouji/css/custom.css" rel="stylesheet">
...
<script src="shouji/js/Chart.js"></script>
<script src="shouji/js/clndr.js"></script>
<script src="shouji/js/custom.js"></script>
<script src="shouji/js/jquery.min.js"></script>

<script src="shouji/js/metisMenu.min.js"></script>
<script src="shouji/js/custom.js"></script>
<script src="shouji/js/d3.v3.js"></script>
<script src="shouji/js/rickshaw.js"></script>
     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">googol管家</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-table nav_icon"></i>业务录入<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="Showgoogol_user.jsp">进货单表</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
	  ...
	  <div class="span_11">
		<div class="col-md-6 col_4">
		  ...
		  --Calender ------
			<link rel="stylesheet" href="shouji/css/clndr.css" type="text/css" />
			<script src="shouji/js/underscore-min.js" type="text/javascript"></script>
			<script src= "shouji/js/moment-2.2.1.js" type="text/javascript"></script>
			<script src="shouji/js/clndr.js" type="text/javascript"></script>
			<script src="shouji/js/site.js" type="text/javascript"></script>
			--End Calender ------
		</div>
